...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Previo 3_ Lilian De la Peña", nullptr, nullptr);
	...
	//GLfloat vertices[] = { //proyecccion ortogonal
 ...
 //     
	...
	glm::mat4 projection=glm::mat4(1); //genera matriz de 4 elementos
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 view=glm::mat4(1); //matriz vista
	   ...
	   view = glm::translate(view, glm::vec3(0.0f,0.0f,-12.0f));
		...
		//comunicaar info al shader para ser dibujado: Uniforms, se envia la informacion al CPU para que el shader la use en el GPU
		...
		model = glm::mat4(1); //genera matriz de 4 elementos
		model = glm::translate(model, glm::vec3(5.0f, 5.0f, 0.0f)); //incializamos la matriz
